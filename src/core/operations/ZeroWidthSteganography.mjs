...
class ZeroWidthSteganography extends Operation {
     ...
     */
    encodeToZeroWidthCharactersText(str1) {
        this.initChars();
     ...
     */
    combineShuffleString(str1, str2) {
        const result = [];
     ...
     */
    decodeFromZeroWidthCharactersText(hiddenText, codelength) {
        this.initChars();
    ...
    encodeText(originalText, hiddenText) {
        const zeroWidthText = this.encodeToZeroWidthCharactersText(hiddenText);
        return this.combineShuffleString(originalText, zeroWidthText);
    }
    ...
    decodeText(text) {
        ...
        return {
            ...
            "hiddenText": this.decodeFromZeroWidthCharactersText(splitted.hiddenText, this.codelengthText)
        };
    }
}
